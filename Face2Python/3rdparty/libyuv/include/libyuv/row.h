...
#define HAS_ABGRTOUV444ROW_NEON
...
#define HAS_NV12TOABGRROW_NEON
#define HAS_NV12TORGB565ROW_NEON
#define HAS_NV21TOARGBROW_NEON
#define HAS_NV21TOABGRROW_NEON
...
void NV12ToARGBRow_NEON(const uint8* src_y,
                        ...
                        const struct YuvConstants* yuvconstants,
                        int width);
void NV12ToABGRRow_NEON(const uint8* src_y,
                        const uint8* src_uv,
                        uint8* dst_abgr,
                        const struct YuvConstants* yuvconstants,
                        int width);
...
void NV21ToARGBRow_NEON(const uint8* src_y,
                        ...
                        const struct YuvConstants* yuvconstants,
                        int width);
void NV21ToABGRRow_NEON(const uint8* src_y,
                        const uint8* src_vu,
                        uint8* dst_argb,
                        const struct YuvConstants* yuvconstants,
                        int width);
...
void ABGRToYJRow_NEON(const uint8* src_abgr, uint8* dst_y, int width);
...
void ARGBToUV444Row_NEON(const uint8* src_argb,
                         ...
                         uint8* dst_v,
                         int width);
void ABGRToUV444Row_NEON(const uint8* src_abgr,
                         uint8* dst_u,
                         uint8* dst_v,
                         int width);
...
void ARGBToUVJRow_NEON(const uint8* src_argb,
                       ...
                       uint8* dst_v,
                       int width);
void ABGRToUVJRow_NEON(const uint8* src_abgr,
                       int src_stride_abgr,
                       uint8* dst_u,
                       uint8* dst_v,
                       int width);
...
void ABGRToYJRow_C(const uint8* src_abgr, uint8* dst_y, int width);
...
void ABGRToYJRow_Any_NEON(const uint8* src_abgr, uint8* dst_y, int width);
...
void ARGBToUV444Row_Any_NEON(const uint8* src_argb,
                             ...
                             uint8* dst_v,
                             int width);
void ABGRToUV444Row_Any_NEON(const uint8* src_abgr,
                             uint8* dst_u,
                             uint8* dst_v,
                             int width);
...
void ARGBToUVJRow_Any_NEON(const uint8* src_argb,
                           ...
                           uint8* dst_v,
                           int width);
void ABGRToUVJRow_Any_NEON(const uint8* src_abgr,
                           int src_stride_abgr,
                           uint8* dst_u,
                           uint8* dst_v,
                           int width);
...
void ARGBToUVJRow_C(const uint8* src_argb,
                    ...
                    uint8* dst_v,
                    int width);
void ABGRToUVJRow_C(const uint8* src_abgr,
                    int src_stride_abgr,
                    uint8* dst_u,
                    uint8* dst_v,
                    int width);
...
void ABGRToUV444Row_C(const uint8* src_abgr,
                      uint8* dst_u,
                      uint8* dst_v,
                      int width);
...
void NV12ToARGBRow_C(const uint8* src_y,
                     ...
                     const struct YuvConstants* yuvconstants,
                     int width);
void NV12ToABGRRow_C(const uint8* src_y,
                     const uint8* src_uv,
                     uint8* rgb_buf,
                     const struct YuvConstants* yuvconstants,
                     int width);
...
void NV21ToARGBRow_C(const uint8* src_y,
                     ...
                     const struct YuvConstants* yuvconstants,
                     int width);
void NV21ToABGRRow_C(const uint8* src_y,
                     const uint8* src_vu,
                     uint8* rgb_buf,
                     const struct YuvConstants* yuvconstants,
                     int width);
...
void NV12ToARGBRow_Any_NEON(const uint8* src_y,
                            ...
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV12ToABGRRow_Any_NEON(const uint8* src_y,
                            const uint8* src_uv,
                            uint8* dst_argb,
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV21ToARGBRow_Any_NEON(const uint8* src_y,
                            ...
                            const struct YuvConstants* yuvconstants,
                            int width);
void NV21ToABGRRow_Any_NEON(const uint8* src_y,
                            const uint8* src_vu,
                            uint8* dst_argb,
                            const struct YuvConstants* yuvconstants,
                            int width);
