...
void ScaleRowDown2_16_C(const uint16* src_ptr,
                        ...
                        uint16* dst,
                        int dst_width);
void ScaleInterveinRowDown2_C(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst,
                              int dst_width);
...
void ScaleRowDown2Linear_16_C(const uint16* src_ptr,
                              ...
                              uint16* dst,
                              int dst_width);
void ScaleInterveinRowDown2Linear_C(const uint8* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8* dst,
                                    int dst_width);
...
void ScaleRowDown2Box_16_C(const uint16* src_ptr,
                           ...
                           uint16* dst,
                           int dst_width);
void ScaleInterveinRowDown2Box_C(const uint8* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8* dst,
                                 int dst_width);
...
void ScaleRowDown4_16_C(const uint16* src_ptr,
                        ...
                        uint16* dst,
                        int dst_width);
void ScaleInterveinRowDown4_C(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst,
                              int dst_width);
...
void ScaleRowDown4Box_16_C(const uint16* src_ptr,
                           ...
                           uint16* dst,
                           int dst_width);
void ScaleInterveinRowDown4Box_C(const uint8* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8* dst,
                                 int dst_width);
...
void ScaleRowDown34_16_C(const uint16* src_ptr,
                         ...
                         uint16* dst,
                         int dst_width);
void ScaleInterveinRowDown34_C(const uint8* src_ptr,
                               ptrdiff_t src_stride,
                               uint8* dst,
                               int dst_width);
...
void ScaleRowDown34_0_Box_16_C(const uint16* src_ptr,
                               ...
                               uint16* d,
                               int dst_width);
void ScaleInterveinRowDown34_0_Box_C(const uint8* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8* d,
                                     int dst_width);
...
void ScaleRowDown34_1_Box_16_C(const uint16* src_ptr,
                               ...
                               uint16* d,
                               int dst_width);
void ScaleInterveinRowDown34_1_Box_C(const uint8* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8* d,
                                     int dst_width);
...
void ScaleCols_16_C(uint16* dst_ptr,
                    ...
                    int x,
                    int dx);
void ScaleInterveinCols_C(uint8* dst_ptr,
                              const uint8* src_ptr,
                              int dst_width,
                              int x,
                              int dx);
...
void ScaleColsUp2_16_C(uint16* dst_ptr,
                       ...
                       int,
                       int);
void ScaleInterveinColsUp2_C(uint8* dst_ptr,
                             const uint8* src_ptr,
                             int dst_width,
                             int x,
                             int dx);
...
void ScaleFilterCols64_C(uint8* dst_ptr,
                         ...
                         int x,
                         int dx);
void ScaleFilterInterveinCols_C(uint8* dst_ptr,
                                const uint8* src_ptr,
                                int dst_width,
                                int x,
                                int dx);
...
void ScaleRowDown38_16_C(const uint16* src_ptr,
                         ...
                         uint16* dst,
                         int dst_width);
void ScaleInterveinRowDown38_C(const uint8* src_ptr,
                               ptrdiff_t src_stride,
                               uint8* dst,
                               int dst_width);
...
void ScaleRowDown38_3_Box_16_C(const uint16* src_ptr,
                               ...
                               uint16* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_3_Box_C(const uint8* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8* dst_ptr,
                                     int dst_width);
...
void ScaleRowDown38_2_Box_16_C(const uint16* src_ptr,
                               ...
                               uint16* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_2_Box_C(const uint8* src_ptr,
                                     ptrdiff_t src_stride,
                                     uint8* dst_ptr,
                                     int dst_width);
...
void ScaleRowDown2_NEON(const uint8* src_ptr,
                        ...
                        uint8* dst,
                        int dst_width);
void ScaleInterveinRowDown2_NEON(const uint8* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8* dst,
                                 int dst_width);
void ScaleRowDown2Linear_NEON(const uint8* src_ptr,
                              ...
                              uint8* dst,
                              int dst_width);
void ScaleInterveinRowDown2Linear_NEON(const uint8* src_ptr,
                                       ptrdiff_t src_stride,
                                       uint8* dst,
                                       int dst_width);
void ScaleRowDown2Box_NEON(const uint8* src_ptr,
                           ...
                           uint8* dst,
                           int dst_width);
void ScaleInterveinRowDown2Box_NEON(const uint8* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8* dst,
                                    int dst_width);
void ScaleRowDown4_NEON(const uint8* src_ptr,
                        ...
                        uint8* dst_ptr,
                        int dst_width);
void ScaleInterveinRowDown4_NEON(const uint8* src_ptr,
                                 ptrdiff_t src_stride,
                                 uint8* dst_ptr,
                                 int dst_width);
void ScaleRowDown4Box_NEON(const uint8* src_ptr,
                           ...
                           uint8* dst_ptr,
                           int dst_width);
void ScaleInterveinRowDown4Box_NEON(const uint8* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8* dst_ptr,
                                    int dst_width);
...
void ScaleRowDown34_NEON(const uint8* src_ptr,
                         ...
                         uint8* dst_ptr,
                         int dst_width);
void ScaleInterveinRowDown34_NEON(const uint8* src_ptr,
                              ptrdiff_t src_stride,
                              uint8* dst_ptr,
                              int dst_width);
void ScaleRowDown34_0_Box_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown34_0_Box_NEON(const uint8* src_ptr,
                                    ptrdiff_t src_stride,
                                    uint8* dst_ptr,
                                    int dst_width);
void ScaleRowDown34_1_Box_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown34_1_Box_NEON(const uint8* src_ptr,
                                        ptrdiff_t src_stride,
                                        uint8* dst_ptr,
                                        int dst_width);
...
void ScaleRowDown38_NEON(const uint8* src_ptr,
                         ...
                         uint8* dst_ptr,
                         int dst_width);
void ScaleInterveinRowDown38_NEON(const uint8* src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8* dst_ptr,
                                  int dst_width);
// 32x3 -> 12x1
void ScaleRowDown38_3_Box_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_3_Box_NEON(const uint8* src_ptr,
                                       ptrdiff_t src_stride,
                                       uint8* dst_ptr,
                                        int dst_width);
// 32x2 -> 12x1
void ScaleRowDown38_2_Box_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown38_2_Box_NEON(const uint8* src_ptr,
                                        ptrdiff_t src_stride,
                                        uint8* dst_ptr,
                                        int dst_width);
...
void ScaleRowDown2Box_Odd_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst,
                               int dst_width);
void ScaleInterveinRowDown2_Any_NEON(const uint8* src_ptr,
                            ptrdiff_t src_stride,
                            uint8* dst,
                            int dst_width);
void ScaleInterveinRowDown2Linear_Any_NEON(const uint8* src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8* dst,
                                  int dst_width);
void ScaleInterveinRowDown2Box_Any_NEON(const uint8* src_ptr,
                               ptrdiff_t src_stride,
                               uint8* dst,
                               int dst_width);
...
void ScaleRowDown4Box_Any_NEON(const uint8* src_ptr,
                               ...
                               uint8* dst_ptr,
                               int dst_width);
void ScaleInterveinRowDown4_Any_NEON(const uint8* src_ptr,
                            ptrdiff_t src_stride,
                            uint8* dst_ptr,
                            int dst_width);
void ScaleInterveinRowDown4Box_Any_NEON(const uint8* src_ptr,
                               ptrdiff_t src_stride,
                               uint8* dst_ptr,
                               int dst_width);
...
void ScaleRowDown34_1_Box_Any_NEON(const uint8* src_ptr,
                                   ...
                                   uint8* dst_ptr,
                                   int dst_width);
void ScaleInterveinRowDown34_Any_NEON(const uint8* src_ptr,
                             ptrdiff_t src_stride,
                             uint8* dst_ptr,
                             int dst_width);
void ScaleInterveinRowDown34_0_Box_Any_NEON(const uint8* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8* dst_ptr,
                                   int dst_width);
void ScaleInterveinRowDown34_1_Box_Any_NEON(const uint8* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8* dst_ptr,
                                   int dst_width);
// 32 -> 12
...
void ScaleRowDown38_2_Box_Any_NEON(const uint8* src_ptr,
                                   ...
                                   uint8* dst_ptr,
                                   int dst_width);
void ScaleInterveinRowDown38_Any_NEON(const uint8* src_ptr,
                                      ptrdiff_t src_stride,
                                      uint8* dst_ptr,
                                      int dst_width);
void ScaleInterveinRowDown38_3_Box_Any_NEON(const uint8* src_ptr,
                                            ptrdiff_t src_stride,
                                            uint8* dst_ptr,
                                            int dst_width);
void ScaleInterveinRowDown38_2_Box_Any_NEON(const uint8* src_ptr,
                                   ptrdiff_t src_stride,
                                   uint8* dst_ptr,
                                   int dst_width);
...
void ScaleFilterCols_NEON(uint8* dst_ptr,
                          ...
                          int x,
                          int dx);
void ScaleFilterInterveinCols_NEON(uint8* dst_ptr,
                                   const uint8* src_ptr,
                                   int dst_width,
                                   int x,
                                   int dx) ;
...
void ScaleFilterCols_Any_NEON(uint8* dst_ptr,
                              ...
                              int x,
                              int dx);
void ScaleFilterInterveinCols_Any_NEON(uint8* dst_ptr,
                              const uint8* src_ptr,
                              int dst_width,
                              int x,
                              int dx);
