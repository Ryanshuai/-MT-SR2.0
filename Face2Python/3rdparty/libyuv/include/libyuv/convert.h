...
// ABGR little endian (rgba in memory) to I444.
LIBYUV_API
int ABGRToI444(const uint8* src_frame,
               int src_stride_frame,
               uint8* dst_y,
               int dst_stride_y,
               uint8* dst_u,
...
// ABGR little endian (rgba in memory) to J420.
LIBYUV_API
int ABGRToJ420(const uint8* src_abgr,
               int src_stride_abgr,
               uint8* dst_yj,
               int dst_stride_yj,
               uint8* dst_u,
...
LIBYUV_API
int ABGRToI400(const uint8* src_abgr,
               int src_stride_abgr,
               uint8* dst_y,
               int dst_stride_y,
               int width,
